...
[wiki](https://github.com/dvbern/lib-excelmerger/wiki), then
[search the issue tracker](https://github.com/dvbern/lib-excelmerger/issues)
to see if someone else in the community has already created a ticket regarding your issue.
If not, feel free to go ahead and [make one](https://github.com/dvbern/lib-excelmerger/issues/new)!
...
[fork lib-excelmerger](https://help.github.com/articles/fork-a-repo)
...
```sh
git remote add upstream git@github.com/dvbern/lib-excelmerger.git
git checkout master
